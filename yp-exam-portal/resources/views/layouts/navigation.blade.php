        ...
        <div class="pt-2 pb-3 space-y-1">
            @auth
                @if(auth()->user()->isLecturer())
                    ...
                    <x-responsive-nav-link :href="route('lecturer.classes.index')" :active="request()->routeIs('lecturer.classes.*')">
                        {{ __('Classes') }}
                    </x-responsive-nav-link>
                    <x-responsive-nav-link :href="route('lecturer.subjects.index')" :active="request()->routeIs('lecturer.subjects.*')">
                        {{ __('Subjects') }}
                    </x-responsive-nav-link>
